...
class editable_wheel(Command):
    ...
    def _configure_build(
        ...
        - Build commands can write to ``build_lib`` if they really want to...
          (but this folder is expected to be ignored and entities are expected to live
    ...
    def _select_strategy(
        ...
        # Use a MetaPathFinder to avoid adding accidental top-level packages/entities
...
def _absolute_root(path: _Path) -> str:
    """Works for packages and top-level entities"""
    path_ = Path(path)
    parent = path_.parent
...
class _NamespaceInstaller(namespaces.Installer):
    ...
    def _get_root(self):
        """Where the entities/packages should be loaded from."""
