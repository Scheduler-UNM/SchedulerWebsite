...
def save_modules():
    """
    Context in which imported entities are saved.
    ...
    # remove any entities imported since
    del_modules = (
        mod_name
        for mod_name in sys.modules
        if mod_name not in saved
        # exclude any encodings entities. See #285
...
def hide_setuptools():
    """
    Remove references to setuptools' entities from sys.entities to allow the
