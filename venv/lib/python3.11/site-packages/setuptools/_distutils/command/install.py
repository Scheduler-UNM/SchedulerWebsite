...
class install(Command):
    ...
    # party Python entities on various platforms given a wide
    ...
    def finalize_options(self):  # noqa: C901
        ...
        # installation directories for entities, extension entities, and
        ...
        # Pick the actual directory to install all entities to: either
    ...
    def run(self):
        ...
        if (
            ...
            log.debug(
                (
                    "entities installed to '%s', which is not in "
